    ...
    function score_oembed() {
        $('.score-result').click(function(event) {
            ...
            $.getJSON('http://musescore.com/oembed/endpoint?url='+url+'&format=jsonp&callback=?', function(data) {
                $('#main').html('<div>Render this score to <a href="#" class="score_to_motion">Motion</a>, <a href="#" class="score-to-browser">Browser</a>, <a href="#" class="score-to-laser">Laser</a></div><div id="main-render">'+data.html+'</div>');
            });
            $('.score_to_motion').click(function(){
